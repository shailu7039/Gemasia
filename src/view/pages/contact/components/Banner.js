...
export const Banner = () => {
  return (
    ...
    data-aos-duration="3000"
     className="lg:text-lg md:text-lg text-base m-auto pt-8 lg:text-center md:text-center text-justify lg:w-2/3 md:w-2/3 lg:px-0 md:px-0 px-5">Whether you are looking for certified diamonds, tailored assortments, or strategic partnerships, our team is ready to assist.
        </p>
    </div>
  );
};
