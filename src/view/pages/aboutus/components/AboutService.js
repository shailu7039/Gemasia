...
export const AboutService = () => {
  return (
    ...
    data-aos-duration="3000">
        <h2 className="lg:text-2xl md:text-2xl text-2xl font-semibold uppercase ">
          About GemAsia
        </h2>
        {/* <h4 className="">How Can We Help You?</h4> */}
        <p className="pt-3 lg:text-lg md:text-xl  text-justify">
        ...
        <p className="pt-2 lg:text-lg md:text-xl text-justify">
        ...
        <ul className="pl-12 pt-3" style={{ listStyleType: 'disc' }}>
          <li className="text-lg pb-1">Heritage: Decades of experience in diamond manufacturing and trading.</li>
          <li className="text-lg pb-1">Expertise: A team of skilled professionals dedicated to quality and precision.</li>
          <li className="text-lg pb-1">Global Reach: A robust network that ensures timely delivery and exceptional service.</li>
          <li className="text-lg pb-1">Sustainability: A commitment to ethical sourcing and responsible business practices.</li>
        </ul>
        <p className="pt-2 lg:text-lg md:text-xl text-justify">
